...
!     INTEGER, PARAMETER :: MION   =  170  ! max.num. of explicit ions
!     INTEGER, PARAMETER :: MLEVEL = 1134  ! max.num. of explicit levels
      INTEGER            :: MION
      INTEGER            :: MLEVEL
      INTEGER            :: MLVEXP
!     INTEGER, PARAMETER :: MLVEXP =  253  ! max.num. of explicit linearized levels
!     INTEGER, PARAMETER :: MTRANS =21000  ! max.num. of all transitions
      INTEGER            :: MTRAN0   
      INTEGER, PARAMETER :: MDEPT0 =  100  ! max.num. of depth points
      INTEGER            :: MTRANS
      INTEGER            :: MDEPTH
      INTEGER, PARAMETER :: MFREQ0=655000  ! max.num. of frequency points
      INTEGER            :: MFREQ
!     INTEGER, PARAMETER :: MFREQP=1940000  ! working arrays of frequency
      INTEGER            :: MFREQP          ! working arrays of frequency
!     INTEGER, PARAMETER :: MFREQC=125000  ! max.num. of freq.points in continuum
      INTEGER            :: MFREQC
!     INTEGER, PARAMETER :: MFREX  =  154  ! max.num. of linearized frequencies
      INTEGER            :: MFREX
!     INTEGER, PARAMETER :: MFREQL =35898  ! max.num. of frequencies per line
      INTEGER            :: MFREQL         ! max.num. of frequencies per line
!     INTEGER, PARAMETER :: MTOT   =  280  ! max.num. of linearized parameters
...
!     INTEGER, PARAMETER :: MITJ   =  380  ! max.num. of overlapping transitions
...
CC    INTEGER, PARAMETER :: MFREQ1 =MFREQ  ! =1 for ISPLIN<5; =MFREQ otherwise
      INTEGER            :: MFREQ1
CC    INTEGER, PARAMETER :: MFRTAB =125000 ! max.num. of freqeuncies in opac.table
!      INTEGER, PARAMETER :: MFRTAB =    3  ! max.num. of freqeuncies in opac.table
CC    INTEGER, PARAMETER :: MTABT  =   21  ! max.number of temps in opac.table
CC    INTEGER, PARAMETER :: MTABR  =   19  ! max.number of densities in opac.table
      INTEGER, PARAMETER :: MDEPTC =    2  ! max.num. of depth points (Compton)
      INTEGER, PARAMETER :: MMUC   =    2  ! max.num. of angle points (Compton)
!     INTEGER, PARAMETER :: MLEVE3 =    1  ! =1 for diag.prec; =MLEVEL for trid.prec.
      INTEGER            :: MLEVE3         ! =1 for diag.prec; =MLEVEL for trid.prec.
!     INTEGER, PARAMETER :: MLVEX3 =    1  ! =1 for diag.oper.; =MLVEXP for tridiag.   .
      INTEGER            :: MLEVEX3        ! =1 for diag.oper.; =MLVEXP for tridiag.
!     INTEGER, PARAMETER :: MTRAN3 =    1  ! =1 for diag.oper; =MTRANS for tridiag.
      INTEGER            :: MTRAN3         ! =1 for diag.oper; =MTRANS for tridiag.
!     INTEGER, PARAMETER :: MCROSS=MLEVEL+15 ! max.num. of b-f cross.secs.
      INTEGER            :: MCROSS         ! max.num. of b-f cross.secs.
!     INTEGER, PARAMETER :: MBF =  MLEVEL  ! max.num. of b-f transitions
      INTEGER            :: MBF
      INTEGER, PARAMETER :: MCFIT  =   10  ! max.num. of collision fit points
      INTEGER, PARAMETER :: MXTCOL =    3  ! max.num. of collision types (CE, CP, CH)
!     INTEGER, PARAMETER :: MCORAT = MTRANS! max.num. of col excitation transitions 
      INTEGER            :: MCORAT         ! max.num. of col excitation transitions
!     
!     Basic physical constants
!
      REAL(DP), PARAMETER :: H     = 6.6256e-27      ! Planck constant     h 
      REAL(DP), PARAMETER :: BOLK  = 1.38054e-16     ! Boltzmann constant  k
      REAL(DP), PARAMETER :: HK    = 4.79928144e-11  ! h/k
      REAL(DP), PARAMETER :: CAS   = 2.997925e18     ! light speed c (A/s)
      REAL(DP), PARAMETER :: EH    = 2.17853041e-11  ! ionizaton energy of hydrogen
      REAL(DP), PARAMETER :: BN    = 1.4743e-2       ! 2*h/c**3, c -light speed
      REAL(DP), PARAMETER :: SIGE  = 6.6516e-25      ! Thomson scattering c-s
      REAL(DP), PARAMETER :: SIG4P = 4.5114062e-6    ! Stefan-Boltzmann const/4pi
      REAL(DP), PARAMETER :: PI4H  = 1.8966e27       ! 4pi/h
      REAL(DP), PARAMETER :: PCK   = 4.19168946e-10  ! 4pi/c
      REAL(DP), PARAMETER :: HMASS = 1.67333e-24     ! mass of hydrogen atom
!
