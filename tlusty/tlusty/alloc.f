...
!*********************************************************************
      ...
      INTEGER, PARAMETER :: MIO0   =  170  ! max.num. of explicit ions
      INTEGER, PARAMETER :: MLEVE0 = 1134  ! max.num. of explicit levels
      INTEGER, PARAMETER :: MME0   =   12  ! max.num. of merged levels
...
C*******************************************************************
     ...
     *                        MFREQ0
      ALLOCATE (FREQ(MFREQ0))
      ALLOCATE (W(MFREQ0))
      ALLOCATE (PROF(MFREQ0))
      ALLOCATE (FREQC(MFREQ0),WCH(MFREQ0))
      ALLOCATE (IJALI(MFREQ0),IJX(MFREQ0),JIK(MFREQ0))
      ALLOCATE (IFREQB(MFREQ0),NLINES(MFREQ0))
c     ALLOCATE (ITKC(MTRANS+2),IJTC(MTRANS+2),(ITJNU(MTRANS+2))
c     ALLOCATE (FRLC(MTRANS+2),FRL1(MTRANS))
